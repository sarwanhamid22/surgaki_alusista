...
<article class="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
    <div class="w-full mx-auto space-y-4 text-center">
        <p class="text-xs font-semibold tracki uppercase"> {{ $pelatihan->kategori }} </p>
        <h1 class="text-4xl font-bold leadi md:text-5xl">{{ $pelatihan->judul_pelatihan }}
        </h1>

    </div>
    <div class="dark:text-gray-100">
        <p class="dark:text-gray-400">{!!html_entity_decode($pelatihan->deskripsi_pelatihan)!!}</p>
    </div>
